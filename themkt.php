...
<body>
    ...
    <div class="">
        <h1><font color="blue"> Thêm mới bài kiểm tra </font> </h1>
        <?php
                 if(isset($_POST["btnThemMoi"])){
                 include_once("DataProvider.php");
                $ma = $_POST['txtID'];
                $question = $_POST['txtIDQuestion'];
                $mark = $_POST['txtIDUser'];
                $type = $_POST['txtTotalSuccess'];
                $translate = $_POST['txtTotalFail'];
                $answer  = $_POST['txtDate'];
        
        
        
                include_once( "DataProvider.php" );
                //$sql = "INSERT INTO questions(ID, ID_Question, ID_User, total_success,total_fail, date) VALUES('" . $ma . "','" . $question . "','" . $mark. "','" . $type . "','" . $translte . "','" . $answer . "')";
        
                $ketqua=DataProvider::ExecuteQuery("INSERT INTO questions (ID, ID_Question, ID_User, total_success, total_fail, date) VALUES ('$ma', '$question', '$mark', '$type', '$translate', '$answer');");
                     if($ketqua== false){
        ...
        <div class="rows">
          <div>
            <form  style="padding-left: 26%;" method="post" enctype="multipart/form-data" name="form1" action="themkt.php">
              ...
              <tr>
                ...
                <tr>
                  <td width="50%">ID câu hỏi</td>
                  <td width="50%"><input type="text" name="txtIDQuestion"/></td>
                </tr>
                <tr>
                  <td>Id người dùng</td>
                ...
                <tr>
                  <td>tổng câu đúng</td>
                  <td><input type="text" name="txtTotalSuccess"/></td>
                </tr>
                <tr>
                  <td>tổng câu sai</td>
                  <td><input type="text" name="txtTotalFail"/></td>
                </tr>
                  <td>Ngày</td>
